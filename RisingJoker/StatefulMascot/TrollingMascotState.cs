...
{
    public class TrollingMascotState : MascotState
    {
        private int speed = 5;
        private int focusedCorner = 0;

        public TrollingMascotState(Player player, Mascot mascot) : base(player, mascot)
        {
            mascot.ChangeColor(Color.BlanchedAlmond);
        }
